...
#Now to calculate the monthly rteurns
#first we need to creat a year_moth column
...
# 4) Calculating the JALSH index returns, by filtering the top 95% of Market Cap
 #first isolate the JALSHAll and calculate returns
